...
export default function SettingsPage() {
  return (
    <>
      ...
      <div className="items-center gap-3 min-w-0 flex-1 mb-6 hidden md:flex overflow-y-auto">
        <div className="p-2 bg-gray-100 rounded-lg flex-shrink-0">
          <SettingsIcon className="h-6 w-6 text-gray-600" />
        </div>
        <div className="min-w-0 flex-1">
          <h1 className="text-xl font-bold text-gray-900 truncate">Settings</h1>
            ...
            <CardContent className="pt-6 space-y-4">
              ...
              <div className="flex items-center justify-between py-2">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-sm">Data & Security</span>
                </div>
        ...
        <Card className="bg-gray-50">
          <CardContent className="pt-6">
            <div className="text-center space-y-2">
              <p className="text-sm font-medium text-gray-900">Fala v1.0.0</p>
              <p className="text-xs text-gray-600">
                Fala is a productivity app that helps you manage your tasks
                efficiently.
              </p>
            </div>
          </CardContent>
